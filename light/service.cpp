...
#define LOG_TAG "android.hardware.light@2.0-service.ef71"
...
const static std::string kRedLedPath = "/sys/class/leds/lp5523:channel6/brightness";

const static std::string kGreenLedPath = "/sys/class/leds/lp5523:channel2/brightness";

const static std::string kBlueLedPath = "/sys/class/leds/lp5523:channel3/brightness";
